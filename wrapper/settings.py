...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'profiles.context_processors.base_data'
            ],
        },
    },
]
...
#     'profiles.authentication.YourCustomAuthBackend'
# ]
...
#Custon settings (define here whatever variable needed by the profiles app)
